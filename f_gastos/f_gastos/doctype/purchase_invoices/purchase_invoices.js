...
erpnext.accounts.PurchaseInvoice = class PurchaseInvoice extends erpnext.buying.BuyingController {
	setup(doc) {
		...
		// formatter for Purchase Invoices item
	...
	onload() {
		...
		this.frm.ignore_doctypes_on_cancel_all = ['Journal Entry', 'Payment Entry', 'Purchase Invoices', "Repost Payment Ledger"];
...
frappe.ui.form.on("Purchase Invoices", {
	setup: function(frm) {
		frm.custom_make_buttons = {
			'Purchase Invoices': 'Return / Debit Note',
